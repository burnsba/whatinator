...
/// The text lame wrote to stderr (its stdout is always empty), filtered by
/// <see cref="LameOutputFilter.ExtractSummary"/> down to the final summary
/// block, for the MP3 log.
/// </param>
